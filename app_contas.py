...
def guess_merchant(description: str) -> str:
 ...
 Ex.:
   'COMPRA PINGO DOCE 1234 LX LISBOA' -> 'PINGO DOCE'
   'PAGAMENTO GALP 0456 LISBOA'       -> 'GALP'
 """
 ...
 # Palavras genéricas pouco úteis
 generic_tokens = {
     "COMPRA",
     "PAGAMENTO",
     "PAGTO",
 ...
 if tokens:
     ...
     # Fallback: usa o texto limpo todo
     key = text
...
"""
 ...
 # 7. Tabela de categorias e descrições
